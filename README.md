...
> **网站**: [https://ayeah.net](https://ayeah.net)
>
> 专注 OpenClaw、AI Agent、自动化等前沿技术，记录数字化转型路上的技术探索与实战经验。

---

## 👋 关于我

一名拥有 20+ 年 IT 从业经验的工程师，专注于制造业信息化建设、数字化转型和流程优化。

在工作中擅长将复杂的业务流程转化为高效的数字化解决方案；业余时间热衷于探索 AI 前沿技术和开源项目。

建立这个博客的目的是分享技术探索与实战经验，希望能结识更多志同道合的朋友。

## 🎯 技术栈

| 领域 | 技术 |
|------|------|
| **AI 智能体** | OpenClaw, Hermes Agent, Dify, Agent 开发 |
| **自动化** | 工作流编排, RPA, CI/CD |
| **Web 开发** | Next.js, Hugo, Vanilla JS |
| **数字化转型** | ERP, MES, PLM |
| **流程优化** | BPM, Lean |
| **开源贡献** | GitHub 社区, 技术分享 |
...
本站使用 **Hugo** 静态站点生成器，搭配自定义暗色主题。目前涵盖以下方向：
...
- [制造业数字员工建设（一）：策划与体系构建](/posts/mfg-digital-worker-01-planning-framework/)
- [制造业数字员工建设（二）：技术选型与训练方法](/posts/mfg-digital-worker-02-technical-selection-training/)
- [制造业数字员工建设（三）：监控体系与 KPI 评估](/posts/mfg-digital-worker-03-monitoring-kpi-evaluation/)
...
│         Hugo 静态站点             │
├─────────────────────────────────┤
│ 内容源：Markdown → Hugo → HTML   │
│ 部署：master 分支 → GitHub Pages  │
│ 主题：自定义暗色主题                │
│ 评论/互动：Discord 社区             │
└─────────────────────────────────┘
```
...
```bash
# 克隆仓库
git clone git@github.com:ayeah/ayeah.git
cd ayeah

# 确保使用 Hugo Extended 版本（v0.161.1+）
hugo version
...
- 🌐 网站: [https://ayeah.net](https://ayeah.net)
- 🐙 GitHub: [@ayeah](https://github.com/ayeah)
- 💬 Discord: [Claw 社区](https://discord.gg/clawd)
- 📧 邮箱: 网站「关于」页面可见

---

> **版权声明**：本站内容采用 [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) 许可协议，转载请注明出处。