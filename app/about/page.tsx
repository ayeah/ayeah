        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="bg-slate-800/50 rounded-2xl p-8 md:p-12 border border-white/10">
              ...
              <p className="text-slate-300 leading-relaxed mb-6">
                虾大师由一群热爱 AI 技术的开发者创建和维护。我们来自不同的背景，有着不同的专业领域，但都对人工智能技术充满热情。团队成员包括资深软件工程师、AI 研究员、产品设计师和技术作家，每个人都为博客贡献独特的视角和经验。
              </p>

              <p className="text-slate-300 leading-relaxed mb-6">
                我们相信，技术的价值在于分享和应用。知识只有传播出去才能产生更大的价值，经验只有分享出来才能帮助更多人少走弯路。通过博客这个平台，我们希望搭建一个技术交流的桥梁，连接 AI 技术的探索者和实践者。
              </p>
